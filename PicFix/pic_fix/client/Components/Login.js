        ...
        return (
            ...
            <View style={{
                ...
                <LinearGradient
                    ...
                    <RN.Button title="Login" style={styles.button} onPress={() => { this.props.navigation.navigate("Library") }} />
                    <Text> Not a member?</Text>
                    <RN.Button title="Sign Up" style={styles.button} onPress={() => { this.props.navigation.navigate("Signup") }} />
